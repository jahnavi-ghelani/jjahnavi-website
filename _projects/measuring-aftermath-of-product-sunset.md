...
Let's take the example of 3 features to characterize product usage in the pre and post periods: active users per month (MAU - a measure of user traffic), median active days per user month (a measure of engagement), days to first (replacement) product activity (a measure of adoption of the product replacing the one being sunset). Here, we assume that the replacement product is an existing product, i.e., it has usage data in the pre-sunset period.  
...
The choice of aggregate depends on the distribution of the cross-sectional metric. Most real-world adoption and engagement distributions tend to be heavily skewed and so, median is chosen here to represent the central tendency.
{: .notice--info}  
...
<details open>
  ...
  #### Sample Period
  Let's assume 6 months of data per feature, immediately pre and post product sunset, for fair comparison<sup>2</sup>.  
...
This brings us to the end to approach 1. 
